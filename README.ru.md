...
Имя репозитория: `markdown-viewer`; имя продукта: **Vellora**.

Подробности: [中文 README](README.md) или [English README](README.en.md).

## Скачать (Windows x64)

[**Установщик Vellora 2.0.0**](https://github.com/mirad-tech/markdown-viewer/releases/download/v2.0.0/Vellora_2.0.0_x64-setup.exe)

- Имя файла: `Vellora_2.0.0_x64-setup.exe`
- Все версии: [Releases](https://github.com/mirad-tech/markdown-viewer/releases)
